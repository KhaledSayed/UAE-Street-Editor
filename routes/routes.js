...
app.post(
  "/profile",
  UserController.helper.upload.single("avatar"),
  UserController.post
);
...
app.post(
  "/section",
  UserController.helper.upload.single("template"),
  SectionController.post
);
app.put(
  "/section",
  UserController.helper.upload.single("template"),
...
app.post(
  "/medium",
  UserController.helper.upload.single("medium"),
  MediumController.post
);
app.put("/medium", MediumController.update);
app.put("/medium/pinned", MediumController.pinned);
